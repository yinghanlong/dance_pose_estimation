...
def train_cli(parser):
    ...
    group.add_argument('--pre-n-images', default=4000, type=int,
    ...
    group.add_argument('--batch-size', default=20, type=int,
                       help='batch size')
...
model_save_filename = '/content/drive/MyDrive/pytorch_Realtime_Multi-Person_Pose_Estimation/evaluate/best_pose.pth'
